...
import com.beshoy.development.BuildConfig;
...
public class NetworkModule {
    ...
    protected String getBaseUrl() {
        return BuildConfig.UFL_API_URL;
    }
    ...
    OkHttpClient provideOkHttpClient(
        ...
        httpClientBuilder.addInterceptor(new OkHttpMockInterceptor(context,
                BuildConfig.Mock_Server_Failure_Percentage,
                BuildConfig.Mock_Server_Min_Delay,
                BuildConfig.Mock_Server_Max_Delay));
